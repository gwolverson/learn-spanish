import { c as create_ssr_component, a as compute_rest_props, g as getContext, b as spread, e as escape_attribute_value, d as escape_object, i as is_void, h as add_attribute } from "./index2.js";
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  gradientOutlineClass = classNames("inline-flex items-center justify-center", sizeClasses[size], rounded(true), "bg-white text-gray-900 dark:bg-gray-900 dark:text-white", "transition-all duration-75 ease-in hover:bg-opacity-0 hover:text-inherit");
  return `${((tag) => {
